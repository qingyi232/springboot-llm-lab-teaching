  ...
  <div class="page-card" v-if="data">
    ...
    <div style="margin-top: 24px; display: flex; gap: 24px;">
      ...
      <div style="flex: 1;">
        ...
        <el-button type="primary" style="margin-top: 20px;" @click="showReserve = true" :disabled="data.zhuangtai !== '空闲'">
    ...
    <el-dialog v-model="showReserve" title="预约申请" width="500px">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="预约时间"><el-date-picker v-model="form.yuyueshijian" type="datetime" placeholder="开始时间" style="width: 100%;" /></el-form-item>
        <el-form-item label="结束时间"><el-date-picker v-model="form.yuyuejieshu" type="datetime" placeholder="结束时间" style="width: 100%;" /></el-form-item>
      </el-form>
